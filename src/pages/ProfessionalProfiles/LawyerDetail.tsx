...
import { ArrowLeft, XCircle, Loader2, FileText, Award, Briefcase, MapPin, Clock, GraduationCap, Users, Building2, Star, CheckCircle, X } from 'lucide-react';
import Button from '../../components/UI/Button.js';
import Modal from '../../components/UI/Modal.js';
import { useAppDispatch, useAppSelector } from '../../store/hooks.js';
import { fetchLawyerProfileById, approveLawyerProfile, rejectLawyerProfile } from '../../store/thunks/professionalProfilesThunks.js';
...
export default function LawyerDetail() {
  ...
  useEffect(() => {
    if (id) {
      dispatch(fetchLawyerProfileById(id));
    }
  }, [id, dispatch]);
  ...
  const handleApprove = async () => {
    ...
    try {
      await dispatch(approveLawyerProfile(id)).unwrap();
  ...
  const handleReject = async () => {
    ...
    setIsProcessing(true);
    try {
      await dispatch(rejectLawyerProfile({
        id,
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <Button onClick={() => navigate('/professional-profiles/lawyers')} className="mt-4">
            Back to Lawyers
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      {/* Profile Header */}
      <ProfileHeader profile={profile} type="lawyer" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Team Information */}
          <TeamInformationSection
            isSoloPractitioner={profile.isSoloPractitioner}
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              required
              className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-200 resize-none"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-700">
            Are you sure you want to approve this lawyer profile? Once approved, the profile will be published and visible to the public.
          </p>
          <div className="flex gap-3 justify-end pt-4">
            <Button
              variant="ghost"
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-700">
            Are you sure you want to reject this lawyer profile? The rejection reason will be sent to the user.
          </p>
          {rejectionReason && (
